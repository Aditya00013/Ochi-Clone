...
function Eyes () {
  ...
  return (
    <div className='eyes w-full h-screen overflow-hidden'>
        ...
        <div className='absolute flex gap-10 w-1/2 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]'></div>
            <div className='flex items-center justify-center w-[15vw] h-[15vw] rounded-full bg-zinc-100'>
                <div className='relative w-2/3 h-2/3 flex rounded-full bg-zinc-900'>
                    <div style={{tranform:`translate(-50%, -50%) rotate(${rotate}deg)`}} className='line absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]  w-full h-10'>
